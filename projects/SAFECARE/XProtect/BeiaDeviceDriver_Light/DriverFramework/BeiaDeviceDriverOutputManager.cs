...
namespace Safecare.BeiaDeviceDriver_Light
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_LightOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_LightOutputManager(BeiaDeviceDriver_LightContainer container) : base(container)
        {
        }
