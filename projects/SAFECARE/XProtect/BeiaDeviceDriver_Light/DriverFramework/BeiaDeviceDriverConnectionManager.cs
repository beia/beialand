...
namespace Safecare.BeiaDeviceDriver_Light
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_LightConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_LightConnectionManager(BeiaDeviceDriver_LightContainer container) : base(container)
        {
        }
