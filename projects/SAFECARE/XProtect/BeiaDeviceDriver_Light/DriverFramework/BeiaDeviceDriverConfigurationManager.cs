...
namespace Safecare.BeiaDeviceDriver_Light
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_LightConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Light Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Light Hardware";
        private const string _serialNumber = "332345";

        private new BeiaDeviceDriver_LightContainer Container => base.Container as BeiaDeviceDriver_LightContainer;

        public BeiaDeviceDriver_LightConfigurationManager(BeiaDeviceDriver_LightContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Light camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Light metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Light microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Light output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Light input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Light speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Light video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Light audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Light speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Light metadata stream",
