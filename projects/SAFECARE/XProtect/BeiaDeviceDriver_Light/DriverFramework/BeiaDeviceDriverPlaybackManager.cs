...
namespace Safecare.BeiaDeviceDriver_Light
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_LightPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_LightPlaybackManager(BeiaDeviceDriver_LightContainer container) : base(container)
        {
