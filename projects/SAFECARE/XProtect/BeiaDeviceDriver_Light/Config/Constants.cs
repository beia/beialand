...
namespace Safecare.BeiaDeviceDriver_Light
{
    public static class Constants
    {
        ...
        {
            Id = new Guid("308C0E4B-88AB-4E52-A9CA-BDB8FD6743DE"),
            Name = "BeiaDeviceDriver_Light"
        };

        public static readonly Guid DriverId = new Guid("7EEAA18A-2828-4C94-904D-C3360D2BA5D4");
