...
namespace Safecare.BeiaDeviceDriver_Fan
{
    public static class Constants
    {
        ...
        {
            Id = new Guid("47B5A33F-D3DA-4AFB-8A6E-72ADA9988C8F"),
            Name = "BeiaDeviceDriver_Fan"
        };

        public static readonly Guid DriverId = new Guid("8B289938-239C-4E52-B631-CA0A81685F11");
