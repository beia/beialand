...
namespace Safecare.BeiaDeviceDriver_Fan
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FanOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_FanOutputManager(BeiaDeviceDriver_FanContainer container) : base(container)
        {
        }
