...
namespace Safecare.BeiaDeviceDriver_Fan
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FanDriverDefinition : DriverDefinition
    {
        /// <summary>
        ...
        {
            return new BeiaDeviceDriver_FanContainer(this);
        }

        protected override DriverInfo CreateDriverInfo()
        {
            // TODO: Replace values below with values describing your driver.
            return new DriverInfo(Constants.DriverId, "BeiaDeviceDriver_Fan", "BeiaDeviceDriver_Fan group", "1.0", new[] { Constants.Product1 });
        }
    }
}
