...
namespace Safecare.BeiaDeviceDriver_Fan
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FanConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_FanConnectionManager(BeiaDeviceDriver_FanContainer container) : base(container)
        {
        }
