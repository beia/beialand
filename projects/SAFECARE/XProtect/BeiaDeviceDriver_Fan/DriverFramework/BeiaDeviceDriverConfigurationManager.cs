...
namespace Safecare.BeiaDeviceDriver_Fan
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FanConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Fan Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Fan Hardware";
        private const string _serialNumber = "1232245";

        private new BeiaDeviceDriver_FanContainer Container => base.Container as BeiaDeviceDriver_FanContainer;

        public BeiaDeviceDriver_FanConfigurationManager(BeiaDeviceDriver_FanContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fan camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fan metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fan microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fan output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fan input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fan speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fan video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fan audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fan speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fan metadata stream",
