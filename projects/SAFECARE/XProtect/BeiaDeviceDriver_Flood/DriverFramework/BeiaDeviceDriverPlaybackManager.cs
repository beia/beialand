...
namespace Safecare.BeiaDeviceDriver_Flood
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FloodPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_FloodPlaybackManager(BeiaDeviceDriver_FloodContainer container) : base(container)
        {
