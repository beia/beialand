...
namespace Safecare.BeiaDeviceDriver_Flood
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FloodConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Flood Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Flood Hardware";
        private const string _serialNumber = "123435";

        private new BeiaDeviceDriver_FloodContainer Container => base.Container as BeiaDeviceDriver_FloodContainer;

        public BeiaDeviceDriver_FloodConfigurationManager(BeiaDeviceDriver_FloodContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Flood camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Flood metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Flood microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Flood output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Flood input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Flood speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Flood video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Flood audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Flood speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Flood metadata stream",
