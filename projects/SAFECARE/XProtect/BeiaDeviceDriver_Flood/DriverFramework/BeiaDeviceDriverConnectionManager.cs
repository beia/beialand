...
namespace Safecare.BeiaDeviceDriver_Flood
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FloodConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_FloodConnectionManager(BeiaDeviceDriver_FloodContainer container) : base(container)
        {
        }
