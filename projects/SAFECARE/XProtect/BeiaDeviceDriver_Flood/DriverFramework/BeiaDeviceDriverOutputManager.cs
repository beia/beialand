...
namespace Safecare.BeiaDeviceDriver_Flood
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FloodOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_FloodOutputManager(BeiaDeviceDriver_FloodContainer container) : base(container)
        {
        }
