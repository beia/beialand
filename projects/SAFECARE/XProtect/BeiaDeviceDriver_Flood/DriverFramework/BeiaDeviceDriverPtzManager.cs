...
namespace Safecare.BeiaDeviceDriver_Flood
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FloodPtzManager : PtzManager
    {
        private new BeiaDeviceDriver_FloodContainer Container => base.Container as BeiaDeviceDriver_FloodContainer;

        public BeiaDeviceDriver_FloodPtzManager(BeiaDeviceDriver_FloodContainer container) : base(container)
        {
        }
