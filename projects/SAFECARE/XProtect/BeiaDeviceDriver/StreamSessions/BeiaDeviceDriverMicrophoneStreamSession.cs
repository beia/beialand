...
namespace Safecare.BeiaDeviceDriver
{
    ...
    /// </summary>
    internal class BeiaDeviceDriverMicrophoneStreamSession : BaseBeiaDeviceDriverStreamSession
    {
        ...
        public BeiaDeviceDriverMicrophoneStreamSession(ISettingsManager settingsManager, BeiaDeviceDriverConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId) :
