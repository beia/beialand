...
namespace Safecare.BeiaDeviceDriver
{
    public static class Constants
    {
        ...
        {
            Id = new Guid("43cd0432-3b95-47f0-a757-03fc70333acb"),
            Name = "BeiaDeviceDriver"
        };

        public static readonly Guid DriverId = new Guid("a129ddc0-e7ca-4ebd-ad08-0d7084ebbfba");
