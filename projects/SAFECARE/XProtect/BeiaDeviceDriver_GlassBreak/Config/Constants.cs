...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    public static class Constants
    {
        ...
        {
            Id = new Guid("74F5557B-E908-4E86-84AC-1A4932BD89C1"),
            Name = "BeiaDeviceDriver_GlassBreak"
        };

        public static readonly Guid DriverId = new Guid("9E976A48-DF25-448B-BE62-C92DBB4922B8");
