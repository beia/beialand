...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_GlassBreakOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_GlassBreakOutputManager(BeiaDeviceDriver_GlassBreakContainer container) : base(container)
        {
        }
