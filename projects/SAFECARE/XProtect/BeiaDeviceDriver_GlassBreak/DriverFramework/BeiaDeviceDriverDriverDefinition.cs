...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_GlassBreakDriverDefinition : DriverDefinition
    {
        /// <summary>
        ...
        {
            return new BeiaDeviceDriver_GlassBreakContainer(this);
        }

        protected override DriverInfo CreateDriverInfo()
        {
            // TODO: Replace values below with values describing your driver.
            return new DriverInfo(Constants.DriverId, "BeiaDeviceDriver_GlassBreak", "BeiaDeviceDriver_GlassBreak group", "1.0", new[] { Constants.Product1 });
        }
    }
}
