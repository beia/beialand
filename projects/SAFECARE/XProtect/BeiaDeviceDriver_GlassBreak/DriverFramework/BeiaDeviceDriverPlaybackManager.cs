...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_GlassBreakPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_GlassBreakPlaybackManager(BeiaDeviceDriver_GlassBreakContainer container) : base(container)
        {
