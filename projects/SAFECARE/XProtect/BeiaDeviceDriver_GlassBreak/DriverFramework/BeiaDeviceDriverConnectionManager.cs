...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_GlassBreakConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_GlassBreakConnectionManager(BeiaDeviceDriver_GlassBreakContainer container) : base(container)
        {
        }
