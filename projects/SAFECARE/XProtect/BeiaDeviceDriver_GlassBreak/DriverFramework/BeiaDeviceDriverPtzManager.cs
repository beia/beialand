...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_GlassBreakPtzManager : PtzManager
    {
        private new BeiaDeviceDriver_GlassBreakContainer Container => base.Container as BeiaDeviceDriver_GlassBreakContainer;

        public BeiaDeviceDriver_GlassBreakPtzManager(BeiaDeviceDriver_GlassBreakContainer container) : base(container)
        {
        }
