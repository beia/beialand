...
namespace Safecare.BeiaDeviceDriver_GlassBreak
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_GlassBreakConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_GlassBreak Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_GlassBreak Hardware";
        private const string _serialNumber = "12342315";

        private new BeiaDeviceDriver_GlassBreakContainer Container => base.Container as BeiaDeviceDriver_GlassBreakContainer;

        public BeiaDeviceDriver_GlassBreakConfigurationManager(BeiaDeviceDriver_GlassBreakContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_GlassBreak metadata stream",
