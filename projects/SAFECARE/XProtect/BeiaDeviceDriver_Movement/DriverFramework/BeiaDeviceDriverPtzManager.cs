...
namespace Safecare.BeiaDeviceDriver_Movement
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_MovementPtzManager : PtzManager
    {
        private new BeiaDeviceDriver_MovementContainer Container => base.Container as BeiaDeviceDriver_MovementContainer;

        public BeiaDeviceDriver_MovementPtzManager(BeiaDeviceDriver_MovementContainer container) : base(container)
        {
        }
