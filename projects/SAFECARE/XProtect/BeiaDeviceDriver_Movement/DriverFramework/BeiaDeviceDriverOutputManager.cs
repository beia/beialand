...
namespace Safecare.BeiaDeviceDriver_Movement
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_MovementOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_MovementOutputManager(BeiaDeviceDriver_MovementContainer container) : base(container)
        {
        }
