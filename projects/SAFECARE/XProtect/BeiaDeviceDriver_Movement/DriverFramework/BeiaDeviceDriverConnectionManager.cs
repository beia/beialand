...
namespace Safecare.BeiaDeviceDriver_Movement
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_MovementConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_MovementConnectionManager(BeiaDeviceDriver_MovementContainer container) : base(container)
        {
        }
