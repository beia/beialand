...
namespace Safecare.BeiaDeviceDriver_Movement
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_MovementDriverDefinition : DriverDefinition
    {
        /// <summary>
        ...
        {
            return new BeiaDeviceDriver_MovementContainer(this);
        }

        protected override DriverInfo CreateDriverInfo()
        {
            // TODO: Replace values below with values describing your driver.
            return new DriverInfo(Constants.DriverId, "BeiaDeviceDriver_Movement", "BeiaDeviceDriver_Movement group", "1.0", new[] { Constants.Product1 });
        }
    }
}
