...
namespace Safecare.BeiaDeviceDriver_Movement
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_MovementPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_MovementPlaybackManager(BeiaDeviceDriver_MovementContainer container) : base(container)
        {
