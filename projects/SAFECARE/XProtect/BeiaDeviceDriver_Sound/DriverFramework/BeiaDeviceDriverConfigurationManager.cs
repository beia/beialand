...
namespace Safecare.BeiaDeviceDriver_Sound
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_SoundConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Sound Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Sound Hardware";
        private const string _serialNumber = "12928";

        private new BeiaDeviceDriver_SoundContainer Container => base.Container as BeiaDeviceDriver_SoundContainer;

        public BeiaDeviceDriver_SoundConfigurationManager(BeiaDeviceDriver_SoundContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Sound camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Sound metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Sound microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Sound output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Sound input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Sound speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Sound video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Sound audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Sound speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Sound metadata stream",
