...
namespace Safecare.BeiaDeviceDriver_Sound
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_SoundOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_SoundOutputManager(BeiaDeviceDriver_SoundContainer container) : base(container)
        {
        }
