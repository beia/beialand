...
namespace Safecare.BeiaDeviceDriver_Sound
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_SoundSpeakerManager : SpeakerManager
    {
        private Guid _streamId;

        private new BeiaDeviceDriver_SoundContainer Container => base.Container as BeiaDeviceDriver_SoundContainer;

        internal BeiaDeviceDriver_SoundSpeakerManager(BeiaDeviceDriver_SoundContainer container) : base(container)
        {
        }
        ...
        public override SpeakerStreamStatus SendFrame(Guid speakerStreamInstance, AudioHeader audioHeader, byte[] data)
        {
            ...
            BeiaDeviceDriver_SoundSpeakerStreamSession s = Container.StreamManager.GetSession(1 /* TODO: Specify correct channel numer */) as BeiaDeviceDriver_SoundSpeakerStreamSession;
            if (s != null)
            {
