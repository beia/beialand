...
namespace Safecare.BeiaDeviceDriver_Sound
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_SoundPtzManager : PtzManager
    {
        private new BeiaDeviceDriver_SoundContainer Container => base.Container as BeiaDeviceDriver_SoundContainer;

        public BeiaDeviceDriver_SoundPtzManager(BeiaDeviceDriver_SoundContainer container) : base(container)
        {
        }
