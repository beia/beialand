...
namespace Safecare.BeiaDeviceDriver_Sound
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_SoundPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_SoundPlaybackManager(BeiaDeviceDriver_SoundContainer container) : base(container)
        {
