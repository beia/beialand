...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FirePlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_FirePlaybackManager(BeiaDeviceDriver_FireContainer container) : base(container)
        {
