...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FireConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Fire Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Fire Hardware";
        private const string _serialNumber = "1234225";

        private new BeiaDeviceDriver_FireContainer Container => base.Container as BeiaDeviceDriver_FireContainer;

        public BeiaDeviceDriver_FireConfigurationManager(BeiaDeviceDriver_FireContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fire camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fire metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fire microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fire output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fire input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fire speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Fire video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fire audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fire speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Fire metadata stream",
