...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FireOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_FireOutputManager(BeiaDeviceDriver_FireContainer container) : base(container)
        {
        }
