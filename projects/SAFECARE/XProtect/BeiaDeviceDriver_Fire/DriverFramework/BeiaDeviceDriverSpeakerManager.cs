...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FireSpeakerManager : SpeakerManager
    {
        private Guid _streamId;

        private new BeiaDeviceDriver_FireContainer Container => base.Container as BeiaDeviceDriver_FireContainer;

        internal BeiaDeviceDriver_FireSpeakerManager(BeiaDeviceDriver_FireContainer container) : base(container)
        {
        }
        ...
        public override SpeakerStreamStatus SendFrame(Guid speakerStreamInstance, AudioHeader audioHeader, byte[] data)
        {
            ...
            BeiaDeviceDriver_FireSpeakerStreamSession s = Container.StreamManager.GetSession(1 /* TODO: Specify correct channel numer */) as BeiaDeviceDriver_FireSpeakerStreamSession;
            if (s != null)
            {
