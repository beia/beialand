...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FireConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_FireConnectionManager(BeiaDeviceDriver_FireContainer container) : base(container)
        {
        }
