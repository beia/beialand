...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_FireDriverDefinition : DriverDefinition
    {
        /// <summary>
        ...
        {
            return new BeiaDeviceDriver_FireContainer(this);
        }

        protected override DriverInfo CreateDriverInfo()
        {
            // TODO: Replace values below with values describing your driver.
            return new DriverInfo(Constants.DriverId, "BeiaDeviceDriver_Fire", "BeiaDeviceDriver_Fire group", "1.0", new[] { Constants.Product1 });
        }
    }
}
