...
namespace Safecare.BeiaDeviceDriver_Fire
{
    ...
    internal class InputPoller
    {
        ...
        public InputPoller(IEventManager eventManager, BeiaDeviceDriver_FireConnectionManager connectionManager,
                ...
                try
                {
                    if (_messageHandler.Initialized && _lastUpdateTime < _messageHandler.Data.Time)
                    {
                        ...
                        _eventManager.NewEvent(Constants.DriverId.ToString(), EventId.OutputChanged,
                            new System.Collections.Generic.Dictionary<string, string> { { "Fire Detection", msg } });
