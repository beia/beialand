...
namespace Safecare.BeiaDeviceDriver_Temp
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_TempOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_TempOutputManager(BeiaDeviceDriver_TempContainer container) : base(container)
        {
        }
