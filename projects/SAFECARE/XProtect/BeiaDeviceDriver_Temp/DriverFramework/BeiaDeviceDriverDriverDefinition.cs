...
namespace Safecare.BeiaDeviceDriver_Temp
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_TempDriverDefinition : DriverDefinition
    {
        /// <summary>
        ...
        {
            return new BeiaDeviceDriver_TempContainer(this);
        }

        protected override DriverInfo CreateDriverInfo()
        {
            // TODO: Replace values below with values describing your driver.
            return new DriverInfo(Constants.DriverId, "BeiaDeviceDriver_Temp", "BeiaDeviceDriver_Temp group", "1.0", new[] { Constants.Product1 });
        }
    }
}
