...
namespace Safecare.BeiaDeviceDriver_Temp
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_TempConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_TempConnectionManager(BeiaDeviceDriver_TempContainer container) : base(container)
        {
        }
