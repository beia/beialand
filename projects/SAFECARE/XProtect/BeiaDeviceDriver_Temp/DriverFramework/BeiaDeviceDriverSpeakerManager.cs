...
namespace Safecare.BeiaDeviceDriver_Temp
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_TempSpeakerManager : SpeakerManager
    {
        private Guid _streamId;

        private new BeiaDeviceDriver_TempContainer Container => base.Container as BeiaDeviceDriver_TempContainer;

        internal BeiaDeviceDriver_TempSpeakerManager(BeiaDeviceDriver_TempContainer container) : base(container)
        {
        }
        ...
        public override SpeakerStreamStatus SendFrame(Guid speakerStreamInstance, AudioHeader audioHeader, byte[] data)
        {
            ...
            BeiaDeviceDriver_TempSpeakerStreamSession s = Container.StreamManager.GetSession(1 /* TODO: Specify correct channel numer */) as BeiaDeviceDriver_TempSpeakerStreamSession;
            if (s != null)
            {
