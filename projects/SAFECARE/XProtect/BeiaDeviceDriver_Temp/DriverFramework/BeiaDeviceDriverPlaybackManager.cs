...
namespace Safecare.BeiaDeviceDriver_Temp
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_TempPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_TempPlaybackManager(BeiaDeviceDriver_TempContainer container) : base(container)
        {
