...
namespace Safecare.BeiaDeviceDriver_Temp
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_TempConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Temp Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Temp Hardware";
        ...
        public BeiaDeviceDriver_TempConfigurationManager(BeiaDeviceDriver_TempContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Temp camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Temp metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Temp microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Temp output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Temp input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Temp speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Temp video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Temp audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Temp speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Temp metadata stream",
