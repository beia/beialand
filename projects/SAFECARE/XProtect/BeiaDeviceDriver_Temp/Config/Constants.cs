...
namespace Safecare.BeiaDeviceDriver_Temp
{
    public static class Constants
    {
        ...
        {
            Id = new Guid("424A9140-2A3D-4CAC-942D-565D64DF2465"),
            Name = "BeiaDeviceDriver_Temp"
        };

        public static readonly Guid DriverId = new Guid("EB370428-AD7A-4694-866C-7CFBB9307359");
