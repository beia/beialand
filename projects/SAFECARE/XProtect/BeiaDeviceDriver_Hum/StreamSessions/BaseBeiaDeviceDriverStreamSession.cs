...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    /// </summary>
    internal abstract class BaseBeiaDeviceDriver_HumStreamSession : BaseStreamSession
    {
        public Guid Id { get; }
        ...
        protected readonly BeiaDeviceDriver_HumConnectionManager _connectionManager;
        ...
        public BaseBeiaDeviceDriver_HumStreamSession(ISettingsManager settingsManager, BeiaDeviceDriver_HumConnectionManager connectionManager, Guid sessionId, string deviceId, Guid streamId)
        {
            Id = sessionId;
