...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_HumConnectionManager : ConnectionManager
    {
        ...
        public BeiaDeviceDriver_HumConnectionManager(BeiaDeviceDriver_HumContainer container) : base(container)
        {
        }
