...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_HumOutputManager : OutputManager
    {
        ...
        public BeiaDeviceDriver_HumOutputManager(BeiaDeviceDriver_HumContainer container) : base(container)
        {
        }
