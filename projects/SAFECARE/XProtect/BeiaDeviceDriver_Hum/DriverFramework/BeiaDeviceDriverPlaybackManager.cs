...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_HumPlaybackManager : PlaybackManager
    {
        ...
        public BeiaDeviceDriver_HumPlaybackManager(BeiaDeviceDriver_HumContainer container) : base(container)
        {
