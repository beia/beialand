...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_HumConfigurationManager : ConfigurationManager
    {
        private const string _firmware = "BeiaDeviceDriver_Humidity Firmware";
        private const string _firmwareVersion = "1.0";
        private const string _hardwareName = "BeiaDeviceDriver_Humidity Hardware";
        ...
        public BeiaDeviceDriver_HumConfigurationManager(BeiaDeviceDriver_HumContainer container) : base(container)
        {
        }
        ...
        protected override ICollection<DeviceDefinitionBase> BuildDevices()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Hum camera",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Hum metadata device",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Hum microphone",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Hum output",
            ...
            {
                DisplayName = "BeiaDeviceDriver_Hum input",
                DeviceId = Constants.Input1.ToString(),
            });

            devices.Add(new SpeakerDeviceDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Hum speaker",
        ...
        private static ICollection<StreamDefinition> BuildCameraStreams()
        {
            ...
            {
                DisplayName = "BeiaDeviceDriver_Hum video stream",
        ...
        private static ICollection<StreamDefinition> BuildAudioStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Hum audio stream",
        ...
        private static ICollection<StreamDefinition> BuildSpeakerStream()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Hum speaker stream",
        ...
        private static ICollection<StreamDefinition> BuildMetadataStreams()
        {
            ...
            streams.Add(new StreamDefinition()
            {
                DisplayName = "BeiaDeviceDriver_Hum metadata stream",
