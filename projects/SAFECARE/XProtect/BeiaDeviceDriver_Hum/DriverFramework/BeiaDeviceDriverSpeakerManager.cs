...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    /// </summary>
    public class BeiaDeviceDriver_HumSpeakerManager : SpeakerManager
    {
        private Guid _streamId;

        private new BeiaDeviceDriver_HumContainer Container => base.Container as BeiaDeviceDriver_HumContainer;

        internal BeiaDeviceDriver_HumSpeakerManager(BeiaDeviceDriver_HumContainer container) : base(container)
        {
        }
        ...
        public override SpeakerStreamStatus SendFrame(Guid speakerStreamInstance, AudioHeader audioHeader, byte[] data)
        {
            ...
            BeiaDeviceDriver_HumSpeakerStreamSession s = Container.StreamManager.GetSession(1 /* TODO: Specify correct channel numer */) as BeiaDeviceDriver_HumSpeakerStreamSession;
            if (s != null)
            {
