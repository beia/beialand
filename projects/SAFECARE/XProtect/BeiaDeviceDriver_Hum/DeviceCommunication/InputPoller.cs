...
namespace Safecare.BeiaDeviceDriver_Hum
{
    ...
    internal class InputPoller
    {
        ...
        public InputPoller(IEventManager eventManager, BeiaDeviceDriver_HumConnectionManager connectionManager,
                ...
                try
                {
                    if (_messageHandler.Initialized && _lastUpdateTime < _messageHandler.Data.Time)
                    {
                        ...
                        _eventManager.NewEvent(Constants.DriverId.ToString(), EventId.OutputChanged,
                            new System.Collections.Generic.Dictionary<string, string> { { "Humidity", msg } });
